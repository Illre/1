let EFV='<div style="position:absolute;z-index:-999;left:-99%;"><a href="https://tmcs.site">team cours</a><a href="https://www.tmcs.site">TMCS</a><a href="https://tmcs.site">team</a></div>';document.querySelector("header")?document.querySelector("header").insertAdjacentHTML("beforeend",EFV):document.body.insertAdjacentHTML("beforeend",EFV);
