document.getElementById("checkout-box").innerHTML = localStorage.getItem("ck"), null === localStorage.getItem("sub2") ? $("#sub-total b").text("Dh. 0") : $("#sub-total b").text(localStorage.getItem("sub2"));
...
function angkaToRp(_0x13ffx4) {
  ...
  ;
  return "Dh. " + _0x13ffx5.split("", _0x13ffx5.length - 1).reverse().join("");
}
...
function hapus() {
  ...
  1 < _0x13ffx6 && $(".hapus").click(function () {
    ...
    $("#sub-total b").text("Dh. 0"), localStorage.setItem("sub2", "Dh. 0");
  });
}
