...
function run() {
    ...
    }), $(_0x46a1[0x12b])[_0x46a1[0x12a]]({loop: true, margin: 10, nav: true, autoplay: owl_autoplay, responsive: {0: {items: 1}, 600: {items: 1}, 1e3: {items: 1}}}) $(_0x46a1[0x118])[_0x46a1[0xa2]](function () {
